...
public class Countries {
    public static final String[][] DATA = {
            ...
            {"BERNIN", "Porto-Novo"}, {"BOTSWANA", "Gaberone"},
    ...
    private static class FlyweightMap
        ...
        private static class Entry
            ...
            public int hashCode() {
                ...
                System.out.println(DATA[index][0].hashCode());
    ...
    public static void main(String[] args) {
        print(capitals(10));
        print(names(10));
        System.out.println(new HashMap<>(capitals(3)).get("BERNIN").hashCode());
