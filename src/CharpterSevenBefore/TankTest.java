...
class Tank {
    ...
    void sayHowFull() {
        if(howFull == 0) System.out.println("CharpterSevenBefore.Tank is empty");
        else System.out.println("CharpterSevenBefore.Tank filling status = " + howFull);
    }
    void empty() {
        howFull = 0;
    }
    protected void finalize() {
        if(howFull != 0)
            System.out.println("Error: CharpterSevenBefore.Tank not empty");
