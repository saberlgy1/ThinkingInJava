...
public class ClassTypeCreator22<T> {
    ...
    public static void main(String[] args) {
        Generic<Integer>[] gia = (Generic<Integer>[])new Object[100];
        ...
        try {
            Building b = (Building)ctcb.createNew("Generics.Ex22.Building");
